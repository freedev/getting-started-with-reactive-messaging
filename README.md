# getting-started-with-reactive-messaging Project
...
You can then execute your native executable with: `./target/getting-started-with-reactive-messaging-1.0.0-SNAPSHOT-runner`
